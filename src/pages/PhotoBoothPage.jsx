...
export default function PhotoBoothPage() {
  ...
  return (
   ...
   <div className="h-25 flex-1 flex items-center justify-center bg-green-500">
     {photos[0] && (
       <img src={photos[0]} alt="Capture 1" className="max-h-full max-w-full object-contain" />
     )}
   </div>

      <div className=" h-25 flex-1 flex items-center justify-center bg-blue-500">
        {photos[1] && (
          <img src={photos[1]} alt="Capture 2" className="max-h-full max-w-full object-contain" />
        )}
      </div>

      <div className="h-25 flex-1 flex items-center justify-center bg-red-500">
        {photos[2] && (
          <img src={photos[2]} alt="Capture 3" className="max-h-full max-w-full object-contain" />
        )}
      </div>

        <div className="h-25 flex-1 flex items-center justify-center bg-purple-500">
          {photos[3] && (
            <img src={photos[3]} alt="Capture 4" className="max-h-full max-w-full object-contain" />
          )}
        </div>
      </div>
    </div>

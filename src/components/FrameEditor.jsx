        ...
        {FRAME_TYPES.map((frame) => {
          ...
          return (
            <button
              ...
              className={`rounded-lg border p-4 text-left transition ${isActive
...
export function FrameColorSection({
  selectedFrameColor,
  onFrameColorChange,
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-3 gap-4 sm:grid-cols-4">
        {FRAME_COLORS.map((palette) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-start gap-2 text-left text-xs font-medium ${isActive ? "text-slate-900" : "text-slate-500"
                }`}
            >
              <span
        ...
        <button
          ...
          className={`flex flex-col items-start gap-2 text-left text-xs font-medium ${selectedFrameColor === "custom"
              ? "text-slate-900"
              : "text-slate-500"
            }`}
        >
          <span
            className={`flex h-10 w-10 items-center justify-center rounded-full border-2 transition ${selectedFrameColor === "custom"
                ? "border-purple-500 ring-2 ring-purple-200"
          ...
          >
            <Plus
              className={`h-5 w-5 ${selectedFrameColor === "custom"
  ...
  return (
    <div className={`space-y-6 ${props.className || ""}`}>
      <div>
        ...
        <FrameLayoutSection {...props} />
      </div>
      <div>
        <h2 className="mb-4 text-base font-semibold text-slate-700">
          Frame Colors
        </h2>
        <FrameColorSection {...props} />
      </div>
    </div>
  );
}
